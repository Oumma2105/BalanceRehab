...
from app.api import board, dashboard, demo, health, ml, patients, placeholders, rehab_games, reports, serial, sessions
...
app.include_router(rehab_games.router, prefix="/api")
